...
public class AlphaPool {
    ...
    private static void setI5Source () {
        ...
        i5system = properties.getProperty("alphasystem");
        i5user = properties.getProperty("alphauser");
        i5pass = properties.getProperty("alphapassword");
        i5total = Integer.parseInt(properties.getProperty("alphatotal"));
